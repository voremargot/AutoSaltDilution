...
function GetPageInfos()
{
    ...
    $result[] = array('caption' => 'Device Magic', 'short_caption' => 'Device Magic', 'filename' => 'device_magic.php', 'name' => 'chrl.device_magic', 'group_name' => 'General Information', 'add_separator' => false, 'description' => '');
    return $result;
}
