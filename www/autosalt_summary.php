 ...
 */
    ...
    class chrl_autosalt_summaryPage extends Page
    {
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for stage_start field
            //
            $editor = new TextEdit('stage_start_edit');
            $editColumn = new CustomEditColumn('Stage Start', 'stage_start', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $editColumn->setAllowListCellEdit(false);
            $editColumn->setAllowSingleViewCellEdit(false);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            //
            // Edit column for stage_average field
            //
            $editor = new TextEdit('stage_average_edit');
            $editColumn = new CustomEditColumn('Stage Average', 'stage_average', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $editColumn->setAllowListCellEdit(false);
            $editColumn->setAllowSingleViewCellEdit(false);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            //
            // Edit column for stage_min field
            //
            $editor = new TextEdit('stage_min_edit');
            $editColumn = new CustomEditColumn('Stage Min', 'stage_min', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $editColumn->setAllowListCellEdit(false);
            $editColumn->setAllowSingleViewCellEdit(false);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            //
            // Edit column for stage_max field
            //
            $editor = new TextEdit('stage_max_edit');
            $editColumn = new CustomEditColumn('Stage Max', 'stage_max', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $editColumn->setAllowListCellEdit(false);
            $editColumn->setAllowSingleViewCellEdit(false);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            //
            // Edit column for stage_std field
            //
            $editor = new TextEdit('stage_std_edit');
            $editColumn = new CustomEditColumn('Stage Std', 'stage_std', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $editColumn->setAllowListCellEdit(false);
            $editColumn->setAllowSingleViewCellEdit(false);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            //
            // Edit column for stage_dir field
            //
            $editor = new ComboBox('stage_dir_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
            $editor->addChoice('R', 'R');
            $editor->addChoice('F', 'F');
            $editor->addChoice('C', 'C');
            $editColumn = new CustomEditColumn('Stage Dir', 'stage_dir', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $editColumn->setAllowListCellEdit(false);
            $editColumn->setAllowSingleViewCellEdit(false);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            //
            // Edit column for salt_volume field
            //
            $editor = new TextEdit('salt_volume_edit');
            $editColumn = new CustomEditColumn('Salt Volume', 'salt_volume', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $editColumn->setAllowListCellEdit(false);
            $editColumn->setAllowSingleViewCellEdit(false);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            //
            // Edit column for discharge_avg field
            //
            $editor = new TextEdit('discharge_avg_edit');
            $editColumn = new CustomEditColumn('Discharge Avg', 'discharge_avg', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $editColumn->setAllowListCellEdit(false);
            $editColumn->setAllowSingleViewCellEdit(false);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            //
            // Edit column for mixing field
            //
            $editor = new TextEdit('mixing_edit');
            $editColumn = new CustomEditColumn('Mixing', 'mixing', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $editColumn->setAllowListCellEdit(false);
            $editColumn->setAllowSingleViewCellEdit(false);
            $this->ApplyCommonColumnEditProperties($editColumn);
