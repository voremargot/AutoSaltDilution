...
"<?php endif; ?>
        class="grid grid-table<?php if (isset ( $this->_tpl_vars['isMasterGrid'] ) && $this->_tpl_vars['isMasterGrid']): ?> grid-master<?php endif; ?><?php if (isset ( $this->_tpl_vars['GridClass'] )): ?> <?php echo $this->_tpl_vars['GridClass']; ?>
<?php endif; ?> js-grid"
